...
// Engine.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEngineApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CEngineApp::OnAppAbout)
...
// CEngineApp construction

CEngineApp::CEngineApp() noexcept
{
	...
	SetAppID(_T("BRCM.EngineBuilder.ChamberDesign.1.0.0.1"));
...
void CEngineApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CEngineApp customization load/save methods

void CEngineApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CEngineApp::LoadCustomState()
{
}

void CEngineApp::SaveCustomState()
{
}
